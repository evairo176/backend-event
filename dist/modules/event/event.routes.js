...
eventRoutes.post('/event', [jwt_strategy_1.authenticateJWT, (0, acl_middleware_1.default)([client_1.ROLE_USER.admin, client_1.ROLE_USER.company_owner])], event_module_1.eventController.create);
eventRoutes.get('/event', event_module_1.eventController.findAll);
eventRoutes.get('/event-company', [jwt_strategy_1.authenticateJWT, (0, acl_middleware_1.default)([client_1.ROLE_USER.company_owner])], event_module_1.eventController.companyFindAll);
eventRoutes.get('/event/:id', event_module_1.eventController.findOne);
eventRoutes.put('/event/:id', [jwt_strategy_1.authenticateJWT, (0, acl_middleware_1.default)([client_1.ROLE_USER.admin, client_1.ROLE_USER.company_owner])], event_module_1.eventController.update);
