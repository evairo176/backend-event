...
ticketRoutes.put('/ticket/:id', [jwt_strategy_1.authenticateJWT, (0, acl_middleware_1.default)([client_1.ROLE_USER.admin, client_1.ROLE_USER.company_owner])], ticket_module_1.ticketController.update);
ticketRoutes.delete('/ticket/:id', [jwt_strategy_1.authenticateJWT, (0, acl_middleware_1.default)([client_1.ROLE_USER.admin, client_1.ROLE_USER.company_owner])], ticket_module_1.ticketController.remove);
